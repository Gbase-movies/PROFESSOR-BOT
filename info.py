...
START_MESSAGE = environ.get('START_MESSAGE', '👋 𝙷𝙴𝙻𝙾 {user}\n\nJina langu naitwa {bot},\nNitakusaidia upate movie uzipendazo kwa kuandika hapo chini jina la kile ukitakacho⚡...')
BUTTON_LOCK_TEXT = environ.get("BUTTON_LOCK_TEXT", "⚠️ 𝙃𝙚𝙮 {query}! Hii sio kwaajili yako tafadhari andika yako hapo chini 😂")
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', 'Request nikuruhusu kwa gharama ndogo tu upate ukipendacho💸!')
RemoveBG_API = environ.get("RemoveBG_API", "")
WELCOM_PIC = environ.get("WELCOM_PIC", "")
WELCOM_TEXT = environ.get("WELCOM_TEXT", "Hai {user}\nwelcome to {chat} nitakusaidia upate movie na series zilizotafasiliwa ⚡")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name} ,promoted by swaflix⚡, {file_size}, SUBSCRIBER https://m.youtube.com/@SWAFLIX")
...
SESSION_STRING = environ.get("SESSION_STRING", "https://t.me/+swSKMviZdY0zMWU0")
