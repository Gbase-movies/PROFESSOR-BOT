...
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', '😂Bofya neno Try again kama umejiunga na channel yetu💸!')
RemoveBG_API = environ.get("RemoveBG_API", "")
WELCOM_PIC = environ.get("WELCOM_PIC", "")
WELCOM_TEXT = environ.get("WELCOM_TEXT", "Hai {user}\nwelcome to {chat} nitakusaidia upate movie na series zilizotafasiliwa kwa offer💸 andika chini jina la movie au series⚡")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name} , SIZE👉  {file_size}  ,👉promoted by swaflix⚡, SUBSCRIBE⚡ https://m.youtube.com/@SWAFLIX")
